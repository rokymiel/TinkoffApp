...
class ConversationViewCell: UITableViewCell, ConfigurableView {
    ...
    func applyTheme() {
        ...
        messageLabel.textColor = RootAssembly.serviceAssembly.theme.currentTheme().textColor
        userNameLabel.textColor = RootAssembly.serviceAssembly.theme.currentTheme().textColor
    }
